# Description: This script shows how to post Az.Storage Analytics logs to Azure Log Analytics workspace using an Azure Automation Runbook
#
...
#     - Use Storage Powershell to enumerate all log blobs in $logs container in all storage accounts across subscriptions
...
#
# Note: This script is sample code. No support is provided. It has been adapted from the original script found here:
...
#######################################################################
# Date calculations to ensure you only ingest the previous hour's logs
